<?php @ini_set('upload_tmp_dir',dirname(dirname(__FILE__)).'/tmp'); if ( @ini_get('session.save_handler') === 'files' ) @ini_set('session.save_path',dirname(dirname(__FILE__)).'/tmp'); ?><?php
/**
